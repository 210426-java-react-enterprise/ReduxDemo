...
class RootControllerTest {
    ...
    @Autowired
    public RootControllerTest(WebApplicationContext webContext, TokenGenerator tokenGenerator) {
    ...
    @Test
     void healthCheckTest() throws Exception {
        ...
        this.mockMvc.perform(get("/health").header("Authorization", token)).andExpect(status().is2xxSuccessful());
    }
}